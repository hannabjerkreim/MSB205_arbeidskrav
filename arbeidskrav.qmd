...
income <- income %>%
  mutate(
    ...
    low = E19101138 +   # Less than $10,000
    ...
    mid = E19101144 +   # $35,000 to $39,999
...
```{r}
# Left join for å få dataene fra WADOH King County inn i dette kartet.
```
